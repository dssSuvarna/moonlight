...
public class ClientNotificationService {
    ...
    public NotificationDTO createNotification(String projectId, String eventId, EventType eventType) {
        ...
        notification.setReceiver(notification.getProject().getOwner());
        notification.setSender(notification.getProject().getClient());
    ...
    public NotificationDTO createMessageNotification(String projectId, String userId, String eventId,
        ...
        notification.setReceiver(userRepository.findByUserId(userId));
    ...
    public List<NotificationDTO> getNotificationsForProject(String projectId) {
        List<NotificationDTO> notificationDTOList = new ArrayList<NotificationDTO>();

        List<Notification> notificationList = new ArrayList<Notification>();

        notificationList = notificationRepository.findUnviewedClientNotificationsByProjectIdAndUserRole(projectId);
