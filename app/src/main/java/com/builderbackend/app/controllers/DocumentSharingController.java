...
import com.builderbackend.app.services.DocumentSharingService;
...
public class DocumentSharingController {
    ...
    @Autowired
    public DocumentSharingController(DocumentSharingService documentSharingService, FolderRepository folderRepository) {
    ...
    public ResponseEntity<FolderDTO> getDocumentsForFolder(@PathVariable String folderId) {
        FolderDTO folderDTO = documentSharingService.getFolderWithFolderId(folderId);
    ...
    public ResponseEntity<FolderDTO> getDocumentsForProject(@PathVariable String projectId) {
        FolderDTO folderDTO = documentSharingService.getDefaultFolderForProjectId(projectId);
    ...
    public ResponseEntity<?> createDocument(
        ...
        DocumentSharingDTO responseDocument = documentSharingService.createDocument(documentSharingDTO, file, folderDTO);
    ...
    public ResponseEntity<?> createFolder(@Valid @RequestBody FolderDTO folderDTO) {
        ...
        FolderDTO responseFolder = documentSharingService.createFolder(folderDTO);
    ...
    public ResponseEntity<Void> deleteDocument(@PathVariable String documentSharingId) {
        try {
            documentSharingService.deleteDocument(documentSharingId);
    ...
    public ResponseEntity<?> deleteFolder(@PathVariable String folderId) {
        try {
            ...
            documentSharingService.deleteFolderIfEmpty(folderId);
            return ResponseEntity.ok().build();
        } catch (Exception e) {
